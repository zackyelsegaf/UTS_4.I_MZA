    ...
    <div class="row py-3 px-3 justify-content-center">
        <div class="col-md-6 mb-2">
            <div class="card bg-green border-radius-default p-4">
                <h4 class="text-center text-green mb-3"><i class="fa-solid fa-signature"></i>&nbsp;&nbsp;&nbsp;Lifia Anggraini - <strong>Tunjangan</strong></h4>
                <marquee direction="right" scrollamount="10">
                <div class="row col-md-12">
                    <div class="col-md-4">
                        <h6 class="text-center text-green"><i class="fa-solid fa-address-card"></i>&nbsp;&nbsp;&nbsp;2313010630</h6>
                    </div>
                    <div class="col-md-4">
